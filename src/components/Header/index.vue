  ...
  >
    ...
    >
      <a-form-model
        ...
        :rules="rules"
      >
        <a-form-model-item label="旧密码" ref="oldPwd" prop="oldPwd">
          <a-input
            type="password"
            @blur="
              () => {
        ...
        <a-form-model-item label="新密码" ref="newPwd" prop="newPwd">
          <a-input
            type="password"
            @blur="
              () => {
        ...
        <a-form-model-item label="确认密码" ref="rePwd" prop="rePwd">
          <a-input
            type="password"
            @blur="
              () => {
