              ...
              >
                <template>
                  <a-form layout="inline">
                    <a-row :gutter="150">
                      <a-col :md="8" :sm="24">
                        <div class="_gl">商品名称</div>
                        <div class="_gr">
                          {{ item.goods_name }}
                        </div>
                      </a-col>
                      <a-col :md="8" :sm="24">
                        <div class="_gl">商品规格</div>
                        <div class="_gr">
                          {{ item.goods_specifition_name_value }}
                        </div>
                      </a-col>
                      <a-col :md="8" :sm="24">
                        <div class="_gl">商品标价</div>
                        <div class="_gr">
                          {{ item.market_price }}
                        </div>
                      </a-col>
                      <a-col :md="8" :sm="24">
                        <div class="_gl">商品实价</div>
                        <div class="_gr">
                          {{ item.retail_price }}
                        </div>
                      </a-col>
                      <a-col :md="8" :sm="24">
                        <div class="_gl">商品数量</div>
                        <div class="_gr">
                          {{ item.number }}
                        </div>
                      </a-col>
                      <a-col :md="8" :sm="24">
                        <div class="_gl">已装数量</div>
                        <div class="_gr">
                          {{ item.installed_number || 0 }}
                        </div>
                      </a-col>
...
import orderApi from "@/api/order/online"
